...
void showControlScreen(void)
{
  String message;
  message += "<html>";
  message += "<head><meta http-equiv=\"refresh\" content=\"60; url='/\"'><title>VHS Laser Tube Control</title></head>";
  message += "<body style=\"font-size : 20px\">";
  message += "<h3>VHS Laser Tube</h3>";
...
//  message += "</form>";
  ...
  message += "</form>";
  message += "<form action=\"/\" method=\"get\">";
  message += "<input type=\"hidden\" name=\"fire\" size=\"1\" value=\"" + (String) fire + "\"><input type=\"submit\" style=\" font-size:30px;position: absolute;width:300px;height:200px;left:50%;margin: 0 0 0 -150px;background: red;\"value=\"FIRE THE LASER!\">";
  message += "</form>";
  message += "</body>";
  message += "</html>";
